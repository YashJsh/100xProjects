  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      senderName: "System",
      role: "SYSTEM",
      content: `Agent Sarah Miller joined conversation ${id || "conv-101"}.`,
      timestamp: "10:15 AM",
    },
    {
      id: "m-2",
    ...
    },
    {
      ...
      role: "AGENT",
      content: "Hi Alex! Checking the logs now.",
      timestamp: "10:18 AM",
    },
  ]);
  ...
  const handleClose = () => {
    ...
    setMessages((prev) => [
      ...prev,
      {
        ...
        senderName: "System",
        role: "SYSTEM",
        content: "Agent Sarah Miller closed this conversation.",
        timestamp: new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }),
      },
    ]);
  };
      ...
      <header className="border-b border-neutral-200 px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          {status !== "CLOSED" && (
            <button
              onClick={handleClose}
              className="px-2.5 py-1 text-xs font-medium border border-neutral-300 rounded hover:bg-neutral-100 transition-colors"
            >
              Close Conversation
            </button>
          )}
      ...
      <main className="max-w-3xl mx-auto w-full flex-1 p-6 flex flex-col justify-between">
        ...
        <form onSubmit={handleSend} className="flex gap-2">
          <input
            ...
            placeholder={status === "CLOSED" ? "Conversation is closed." : "Type your reply..."}
